...
class InvitationFormSharable extends StatefulWidget {
  const InvitationFormSharable({super.key});

  @override
  State<InvitationFormSharable> createState() => _InvitationFormSharableState();
}

class _InvitationFormSharableState extends State<InvitationFormSharable> {
  @override
  void initState() {
    super.initState();
  }
